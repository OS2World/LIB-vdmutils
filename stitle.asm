; Subroutine to set the title bar text of a VDM session.
...
_TEXT      SEGMENT  WORD READONLY PUBLIC 'CODE'
           PUBLIC   DWNSETSESSIONTITLE
DWNSETSESSIONTITLE PROC FAR PASCAL
           ...
           MOV      CX,636CH    ;  ... for setting the ...
           MOV      DX,1H       ;  ... title bar's text.
